...
# from models.birds_get_tree_target import get_label_list
#from models.butterfly_get_tree_target import get_label_list
...
def train_one_epoch(config, model, criterion, data_loader, optimizer, epoch, mixup_fn, lr_scheduler):
    ...
    for idx, (samples, targets) in enumerate(data_loader):
        ...
        score, _ = model(samples, labels_input)
...
def validate(config, data_loader, model):
    ...
    for idx, (images, target) in enumerate(data_loader):
        ...
        # compute output
        # print('target:', target)
        decode_result, _ = model.module.generate(images)
        ...
        acc1 = (test_order_acc + test_family_acc + test_species_acc)/4
