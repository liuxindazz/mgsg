...
def load_pretrained(config, model, logger):
    ...
    for k in relative_position_bias_table_keys:
        ...
        relative_position_bias_table_current = model.encoder.state_dict()[k]
    ...
    for k in absolute_pos_embed_keys:
        ...
        absolute_pos_embed_current = model.encoder.state_dict()[k]
    ...
    Nc2 = model.encoder.head.bias.shape[0]
    if (Nc1 != Nc2):
